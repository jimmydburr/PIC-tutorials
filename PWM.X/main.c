...
int main(void)
{
    ...
    CCPR1 = 77;                 // CCP1 compare value is 77 for 50% duty cycle
    // configure Timer 2
    PR2 = 155;                  // Timer 2 max value is (1MHz / 4*16*1kHz)-1 = 155
    ...
    while (1)
    {
        // count up from 0 to PR2 to vary the duty cycle from 0 to 100%
        for (unsigned char i = 0; i <= 155; i++)
        {
            CCPR1 = i;      // set CCP1 compare value
            __delay_ms(6);
        }
    }
    return 0;
